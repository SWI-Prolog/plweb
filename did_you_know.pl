...
dyk_sayings([
    ...
    'SWI-Prolog has a full featured web framework'-'/pldoc/package/http.html',
    ...
    ['ETALIS is a system for ', b('Complex Event Processing'), ' that runs on SWI-Prolog']-'http://code.google.com/p/etalis/',
    'The SWI-Prolog code that drives this website is available via GIT'-'git://www.swi-prolog.org/home/pl/git/plweb.git',
    'SWI-Prolog can talk to Matlab'-'/contrib/SamerAbdallah/index.html',
...
['Jan loves it when you ', b('Report Bugs')]-'/bugzilla/',
    ...
    'SWI-Prolog licensing allows use in proprietary applications'-'/license.html',
    ...
    ['SWI-Prolog has software to ', b('keep track of Licenses'), '(GPL, LGPL, etc.)']-'/pldoc/doc_for?object=section(2,''E.3'',swi(''/doc/Manual/softlicense.html''))',
